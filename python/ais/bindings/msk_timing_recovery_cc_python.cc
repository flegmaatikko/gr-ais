...
/* BINDTOOL_HEADER_FILE_HASH(e24fb97df0a6cbdaf2bbbea66089474f) */
/***********************************************************************************/
...
void bind_msk_timing_recovery_cc(py::module &m) {
  ...
  using msk_timing_recovery_cc = ::gr::ais::msk_timing_recovery_cc;
  ...
  py::class_<msk_timing_recovery_cc, gr::block, gr::basic_block,
      ...
      .def(py::init(&msk_timing_recovery_cc::make), py::arg("sps"),
           py::arg("gain"), py::arg("limit"), py::arg("osps"),
           D(msk_timing_recovery_cc, make))

      .def("set_gain", &msk_timing_recovery_cc::set_gain, py::arg("gain"),
           D(msk_timing_recovery_cc, set_gain))

      .def("get_gain", &msk_timing_recovery_cc::get_gain,
           D(msk_timing_recovery_cc, get_gain))

      .def("set_limit", &msk_timing_recovery_cc::set_limit, py::arg("limit"),
           D(msk_timing_recovery_cc, set_limit))

      .def("get_limit", &msk_timing_recovery_cc::get_limit,
           D(msk_timing_recovery_cc, get_limit))

      .def("set_sps", &msk_timing_recovery_cc::set_sps, py::arg("sps"),

...
/* BINDTOOL_HEADER_FILE_HASH(d512a59d280bf96e50c351b77dd39bdf) */
/***********************************************************************************/
...
void bind_pdu_to_nmea(py::module &m) {
  ...
  py::class_<pdu_to_nmea, gr::block, gr::basic_block,
      ...
      .def(py::init(&pdu_to_nmea::make), py::arg("designator"),
           D(pdu_to_nmea, make))

      .def("to_nmea", &pdu_to_nmea::to_nmea, py::arg("arg0"),
           D(pdu_to_nmea, to_nmea))

      .def("print", &pdu_to_nmea::print, py::arg("arg0"), D(pdu_to_nmea, print))
